...
public class Task implements Serializable {
    ...
    private String projectId; // Added projectId attribute
    private int progress;

    // Default constructor required for Firebase
    public Task() {}

    public Task(String id, String title, String description, String startDate, String endDate, int progressPercentage, String projectId) {
        this.id = id;
        this.title = title;
    ...
    // ... equals, hashCode, toString method
